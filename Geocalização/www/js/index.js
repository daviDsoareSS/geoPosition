...
function stopObservePosition(){
    var watchID = navigator.geolocation.watchPosition(window.watchID);
}
...
function onDeviceReady() {
    ...
    alert("Geocalização obtida... ");
    alert(navigator.geolocation);

    window.watchID = navigator.geolocation.watchPosition(onGeolocationSucess,onGeolocationError,optionsLocation);
